...
class HierPolicyAlgo:
    ...
    def __init__(self, envs, hi_policy_value_net, lo_policy_value_net, device, preprocess_obss, train_lo, train_hi,
            ...
            max_grad_norm, optim_eps, n_skills
        ):
        ...
        self.action_space_shape = (envs[0].action_space.shape[0] + 1 ,)
        ...
        self.cur_skills = [None for i in range(self.num_procs)]
