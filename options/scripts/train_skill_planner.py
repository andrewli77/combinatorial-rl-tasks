...
# Load algo
policy_algo = torch_ac.algos.HierPolicyAlgo(envs, hi_policy_value_net, lo_policy_value_net, device, preprocess_obss, args.train_lo, args.train_hi,
                        ...
                        args.max_grad_norm, args.optim_eps, args.n_skills
                )
...
while num_frames < args.frames:
    ...
    if update % args.log_interval == 0:
        ...
        if args.train_lo:
            header += ["lo_entropy", "lo_value", "lo_policy_loss", "lo_value_loss", "lo_grad_norm", "termination_rate"] 
            data += [logs["lo_entropy"], logs["lo_value"], logs["lo_policy_loss"], logs["lo_value_loss"], logs["lo_grad_norm"], logs["termination_rate"]] 
