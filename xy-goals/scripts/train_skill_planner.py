...
# Load model
hi_policy_value_net = HighPolicyValueModel(obs_space, args.hidden_size)
lo_policy_value_net = LoPolicyValueModel(obs_space, envs[0].action_space, args.hidden_size)
...
policy_algo = torch_ac.algos.HierPolicyAlgo(envs, hi_policy_value_net, lo_policy_value_net, device, preprocess_obss,
                        ...
                        args.max_grad_norm, args.optim_eps, args.skill_len
                )
