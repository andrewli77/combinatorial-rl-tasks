...
def make_train_env(env_name, hier=False, num_training_tasks = 100, rng_seed = 0):
    ...
    elif env_name in ['PointTSP-v0', 'PointTSP-v1', 'PointTSP-v2', 'PointTSP-v3', 'PointTTSP-v0', 'PointTTSP-v1', 'PointTTSP-v3', 'CarTSP-v0', 'DoggoTSP-v0', 'ColourMatch-v0', 'ColourMatch-v3']:
        if hier:
...
def make_test_env(env_name, hier=False, seed=1000):
    ...
    elif env_name in ['PointTSP-v0', 'PointTSP-v1', 'PointTSP-v2', 'PointTSP-v21', 'PointTSP-v3', 'PointTSP-v4', 'PointTSP-v5', 'PointTTSP-v0', 'PointTTSP-v1', 'PointTTSP-v3', 'CarTSP-v0', 'DoggoTSP-v0', 'ColourMatch-v0', 'ColourMatch-v2', 'ColourMatch-v3']:
